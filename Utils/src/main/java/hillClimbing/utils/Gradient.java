...
public class Gradient
{
    public enum GradientType {
        ...
        GradientType(final String text) {
            this.text = text;
        }
        ...
        static public Boolean isValid(final String strategyString) {
            ...
            for (GradientType enumStrat : GradientType.values()) {
    ...
    public static Color[] getGradientFromEnum(final GradientType t) {
        if(t == GradientType.MAROON_TO_GOLD) {
            return Gradient.MAROON_TO_GOLD;
        }
        else if(t == GradientType.BLUE_TO_RED) {
            return Gradient.BLUE_TO_RED;
        }
        else if(t == GradientType.BLACK_TO_WHITE) {
            return Gradient.BLACK_TO_WHITE;
        }
        else if(t == GradientType.RED_TO_GREEN) {
            return Gradient.RED_TO_GREEN;
        }
        else if(t == GradientType.GREEN_YELLOW_ORANGE_RED) {
            return Gradient.GREEN_YELLOW_ORANGE_RED;
        }
        else if(t == GradientType.RAINBOW) {
            return Gradient.RAINBOW;
        }
        else if(t == GradientType.HOT) {
            return Gradient.HOT;
        }
        else if(t == GradientType.HEAT) {
            return Gradient.HEAT;
        }
        else if(t == GradientType.ROY) {
            return Gradient.ROY;
        }
        else {
            return Gradient.RAINBOW;
     ...
     */
    public final static Color[] MAROON_TO_GOLD = createGradient(new Color(0xA0, 0x00, 0x00), new Color(0xFF, 0xFF, 0x00), 500);

    /**
     * Produces a gradient from blue (low) to red (high)
     */
    public final static Color[] BLUE_TO_RED = createGradient(Color.BLUE, Color.RED, 500);

    /**
     * Produces a gradient from black (low) to white (high)
     */
    public final static Color[] BLACK_TO_WHITE = createGradient(Color.BLACK, Color.WHITE, 500);

    /**
     *Produces a gradient from red (low) to green (high)
     */
    public final static Color[] RED_TO_GREEN = createGradient(Color.RED, Color.GREEN, 500);

    /**
     *Produces a gradient through green, yellow, orange, red
     */
    public final static Color[] GREEN_YELLOW_ORANGE_RED = createMultiGradient(new Color[]{Color.green, Color.yellow, Color.orange, Color.red}, 500);

    /**
     *Produces a gradient through the rainbow: violet, blue, green, yellow, orange, red
     */
    public final static Color[] RAINBOW = createMultiGradient(new Color[]{new Color(181, 32, 255), Color.blue, Color.green, Color.yellow, Color.orange, Color.red}, 500);

    /**
     *Produces a gradient for hot things (black, red, orange, yellow, white)
     */
    public final static Color[] HOT = createMultiGradient(new Color[]{Color.black, new Color(87, 0, 0), Color.red, Color.orange, Color.yellow, Color.white}, 500);

    /**
     *Produces a different gradient for hot things (black, brown, orange, white)
     */
    public final static Color[] HEAT = createMultiGradient(new Color[]{Color.black, new Color(105, 0, 0), new Color(192, 23, 0), new Color(255, 150, 38), Color.white}, 500);

    /**
     *Produces a gradient through red, orange, yellow
     */
    public final static Color[] ROY = createMultiGradient(new Color[]{Color.red, Color.orange, Color.yellow}, 500);
