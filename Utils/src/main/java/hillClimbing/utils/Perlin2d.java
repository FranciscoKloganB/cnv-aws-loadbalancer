...
import hillClimbing.utils.interpolator.CosineInterpolator;
import hillClimbing.utils.interpolator.Interpolator;
...
public class Perlin2d {
    ...
    public double perlinNoise2(double x, double y) {
        double total = 0;
        int f = 1;
        double a = 1;
        for (int i = 0; i < octaves; ++i) {
